								...
								<div class="dropdown-menu">
									<div class="menu-header-content bg-primary text-right">
										<div class="d-flex">
											...
											<span class="badge badge-pill badge-warning mr-auto my-auto float-left">
												<a href="{{url('MarkAsRead_all')}}">تحديد الكل مقروء</a>
											</span>
										</div>
										<p class="dropdown-title-text subtext mb-0 text-white op-6 pb-0 tx-12 ">
											لديك
											<span id="notifications_count">{{auth()->user()->unreadNotifications->count()}}</span> اشعارات غير مقروءة
										</p>
									</div>
									...
									<div class="main-notification-list Notification-scroll" id="unread_notifications">
										@foreach(auth()->user()->unreadNotifications as $notification)
											...
											<a class="d-flex p-3 border-bottom" href="{{url('invoices_details')}}/{{$notification->data['id']}}">
