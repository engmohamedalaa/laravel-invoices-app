				...
				<div class="row row-sm">
									...
									<div class="d-flex">
										...
										<span class="float-right my-auto mr-auto">
											...
											<span class="text-white op-7">
												<?php
												$all_invoices_count    = \App\invoices::count();
												$unpaid_invoices_count = \App\invoices::where('value_status', 2)->count();
												?>
												{{round($unpaid_invoices_count/$all_invoices_count  * 100)}}%
											</span>
										</span>
									</div>
								</div>
								...
								<div class="pb-0 mt-0">
									<div class="d-flex">
										...
										<span class="float-right my-auto mr-auto">
											<i class="fas fa-arrow-circle-up text-white"></i>
											<span class="text-white op-7">
												{{round(\App\invoices::where('value_status', 1)->count()/$all_invoices_count  * 100)}}%
											</span>
										</span>
									</div>
								</div>
					...
					<div class="col-xl-3 col-lg-6 col-md-6 col-xm-12">
						<div class="card overflow-hidden sales-card bg-warning-gradient">
							<div class="pl-3 pt-3 pr-3 pb-2 pt-0">
								<div class="">
									<h6 class="mb-3 tx-12 text-white">الفواتير المدفوعة الجزئية</h6>
								</div>
								<div class="pb-0 mt-0">
									<div class="d-flex">
										<div class="">
										...
										<span class="float-right my-auto mr-auto">
											<i class="fas fa-arrow-circle-down text-white"></i>
											<span class="text-white op-7">
												{{round(\App\invoices::where('value_status', 3)->count()/$all_invoices_count  * 100)}}%
											</span>
										</span>
									</div>
								</div>
